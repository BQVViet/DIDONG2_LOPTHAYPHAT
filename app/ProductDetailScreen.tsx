...
//                       style={[
//                         styles.optionText,
//                         selectedSize === s && styles.optionTextActive,
//                       ]}
//                     >
//                       {s}
//                     </Text>
...
//           {/* ===== COLOR (CHỈ HIỆN KHI CÓ) ===== */}
//           {product.colors && product.colors.length > 0 && (
//             <>
//               <Text style={styles.label}>Màu sắc</Text>
//               <View style={styles.colorWrap}>
//                 {product.colors.map((c: string) => ( // Sửa từ 'any' thành 'string'
//                   <TouchableOpacity
//                     key={c} // Sử dụng trực tiếp tên màu làm key
//                     onPress={() => setSelectedColor(c)} // Sử dụng trực tiếp c
//                     style={[
//                       styles.colorItem,
...
//                       style={[
//                         styles.colorCircle,
//                         // Nếu bạn muốn hiện màu dựa theo tên, có thể viết một hàm map màu ở đây
//                         // Hiện tại để màu xám nhẹ làm nền cho chuyên nghiệp
//                         { backgroundColor: '#e5e7eb' }, 
//                         selectedColor === c && { borderColor: '#ee4d2d' }
//                       ]}
//                     />
//                     <Text style={[
//                       styles.colorText,
//                       selectedColor === c && { color: '#ee4d2d', fontWeight: 'bold' }
//                     ]}>
//                       {c}
//                     </Text>
//                   </TouchableOpacity>
...
//               style={[styles.counterBtn, styles.counterActive]}
//             >
...
//   // Trên Android, ta đẩy cao lên 20-25 đơn vị để né thanh điều hướng.
//   // Trên iOS, đẩy cao 30-34 đơn vị để né thanh vuốt (Home Indicator).
//   paddingBottom: Platform.OS === 'ios' ? 34 : 24, 
  
//   // Đổ bóng để footer trông nổi bật hơn trên nền trắng
//   shadowColor: '#000',
...
// cartBtn: {
//   flex: 0.4,
//   height: 50, // Tăng nhẹ chiều cao để bấm dễ hơn
//   borderRadius: 8,
//   borderWidth: 1.5,
//   borderColor: '#ee4d2d',
//   backgroundColor: '#fff',
...
//   justifyContent: 'center',
//   alignItems: 'center',
//   // Thêm độ bóng cho nút mua ngay cho chuyên nghiệp
//   shadowColor: '#ee4d2d',
//   shadowOffset: { width: 0, height: 4 },
//   shadowOpacity: 0.2,
//   shadowRadius: 4,
